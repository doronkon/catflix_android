...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    private List<CategoryHelper> categoryList;

    public CategoryAdapter(Context context, List<CategoryHelper> categoryList) {
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
        CategoryHelper category = categoryList.get(position);

        // Set category title
        holder.categoryTitle.setText(category.getName());

        // Setup the horizontal RecyclerView for movies
